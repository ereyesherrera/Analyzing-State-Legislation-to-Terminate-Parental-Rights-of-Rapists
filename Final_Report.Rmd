...
The viz below examines the equal pay rank and proportion of equal pay for each state against law strength. It is essential to note here that proportions and rankings are updated to 2018 numbers, which for some states that passed legislation in the '90s, like California, Texas, Missouri and Pennsilvania, is not necessarily reflective of the climate at the time of passage. The clusterings that we see with the gradient tell us that, as we might have intutively expected, states with higher proportions of equal pay have better rankings in terms of their equal pay laws, and vise verse. What the vizualisation reveals in terms of law strength is that these variables are not necessarily great predictors for the scope of the legislation. Smaller and larger dots are in no particular order or color across the vizualisation.
...
In this visualization we looked at how the % of women in state legislatures affected law strength, broken up by political party. A few groupings immediately stand out: the states with law strength 5 are all grouped together, with the exception of Mississippi. The blue states with more than 30% women have the highest law strength. In addition, it is important to note that 4 states with low law strengths, CA, MO, TX, and PA were all passed in the 90s. They have lower % of women and lower law strength but they were passed much earlier than other states. 
Overall, there seems to be a positive relationship between the amount of women in the state legislature and the highest law strength. However, for law strengths 1-4, there seems to be more variability.  


From all of these visualizations, we see some general trends that might lead a state to adopt a law strength of 5. A higher  availability of abortion and health clinics seems to be clearly related to stronger laws. And there does seem to be a weak positive relationship between the percentage of women legislators and law strength. However, across all of the variables there does not seem to be a single clear predictor of law strength. This speaks to the complicated nature of how legislation is ultimately passed. In the next section we will discuss this complexity in greater depth.  
