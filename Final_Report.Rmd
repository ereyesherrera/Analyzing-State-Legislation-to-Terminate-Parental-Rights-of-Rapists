...
Another surprising finding is that the percentage of women in both chambers of a state legislature does not necessarily lead to a better law strength, especially when also considering the party at the time of legislation. We can see that this may be the case for Blue states, where there seems to be a relationship between the percentage of women in the state legislature and law strength, but the relationship is much more complicated for Red states. As such, we are again left to wonder other factors that are driving states to push for a better law strength.
...
All in all, analyzing specific variables in our data set as it pertains to a state's law strength reveal that there is really no distinguishable pattern in how states are deciding to rule on this problem despite some variables reflecting perfectly what we would expect in terms of representation and resources for women and the legislaion in question. Though these variables represent important factors to consider when discussing women's rights and resources available to them, we observed when comparing three very different states with the same law strength that there must be un underlying driving force in how the legislation is being treated. These variables are only the beginning when understanding this issue and serve as a basis for how states need to improve.
