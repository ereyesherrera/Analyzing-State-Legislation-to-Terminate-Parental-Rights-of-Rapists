...
=======
Currently, every state but Minnesota has legislation to terminate the parental rights of rapists. However, this legislation varies considerably from state to state with respect to timing and scope. While some passed legislation in the 90s, many have waited until after 2015 to pass or amend their laws. Another key variant across states is the strength of the legislation, which we define on a five point scale (1= no legislation at all, 2= requiring a rape conviction for termination, 3= ambiguous burden of proof, 4= beyond a reasonable doubt, 5= clear and convincing evidence). Incongruities across the country beg the question: What accounts for these legislative differences? In this project, we consider how a state’s partisan divides, policy-making context ("focusing events" and framing), and favorability to, and representation of, women influence legislation's presense and scope. This data was compiled by Emma Higgins for her honors thesis using a litany of legislative and policy data sets. Her group members have kindly obliged her obsession and agreed to dedicate fifty hours to analyzing her niche data set!
>>>>>>> f84ddf2b86c7722622f477bd086d1c6e390b8c4f
...
=======
>>>>>>> fe59c136691db587b230d335858f8e683a8dab0b
...
=======
Data visualizations representing law passage and strength over time indicate stronger and more abundant laws protecting rape victim's rights to child custody since 2010.  Though it is difficult to clearly realte the evidence of focusing events such as the CNN stories and The Rape Survivor Child Custody Act as heavily impacting the passage of laws, there is an undeniable trend of states passing landmark custody legislation after around 2010.  Regarding focus events impacting law strength, states that ammended their laws after 2010 showed multiple trends of favoring a higher calliber of the law power. This could be because of the multiple CNN stories impacts on the public concious or the legal influence of The Rape Survivor Child Custody of 2015.   
>>>>>>> f84ddf2b86c7722622f477bd086d1c6e390b8c4f
...
The viz below examines the equal pay rank and proportion of equal pay for each state against law strength. It is essential to note here that proportions and rankings are updated to 2018 numbers, which for some states that passed legislation in the '90, like California, Texas, Missouri and Pennsilvania, are not necessarily reflective of the climate at the time of passage.
...
=======
>>>>>>> 51ebfba669e086b475b3c8f6e8ffc810aa5eca3c
